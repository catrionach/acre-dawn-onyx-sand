...
import { B as redirect, S as useRouter, _ as createFileRoute, d as HeadContent, f as useRouterState, g as lazyRouteComponent, h as Outlet, m as createRouter, u as Scripts, v as createRootRoute, y as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { a as require_jsx_runtime, i as useQueryClient, n as useQuery, r as QueryClientProvider, t as useMutation } from "../_libs/react+tanstack__react-query.mjs";
import { l as __exportAll, r as createServerFn } from "./ssr.mjs";
import { B as pinStatus, C as floorToSheets, D as getPglite, J as unlockFloor, K as todayIso, Y as zipFromFloor, a as SHEET_SPECS, b as ensureDbReady, f as WO_STATUSES, ft as toCsv, i as SCHEMA_DOC, l as TICKET_STATUSES, o as SO_STATUSES, r as QT_CAUSES, s as TASK_STATUSES, t as BUILDERS, u as UNIT_STATUSES, v as createSsrRpc, w as formatShopDate, z as pinMiddleware } from "./types-CcVUDIXB.mjs";
import { $t as BetterAuthError, A as decodeProtectedHeader, At as import_src, Bt as generateId, C as toResponse, Dt as ATTR_CONTEXT, E as filterOutputFields, Et as withSpan, Ft as runWithAdapter, Ht as createLogger, It as runWithTransaction, Kt as env, Lt as getBetterAuthVersion, M as jwtVerify, Mt as getAuthTables, Nt as getCurrentAdapter, O as base64Url, Ot as ATTR_HOOK_TYPE, Pt as queueAfterTransactionHook, Qt as APIError, Rt as initGetModelName, S as createRouter$1, T as serializeSignedCookie, Ut as logger, Vt as createRandomStringGenerator, Wt as shouldPublishLog, Xt as isProduction, Yt as isDevelopment, Zt as isTest, _ as defineRequestState, _n as union, a as betterFetch, an as _enum, b as getCurrentAuthContext, c as isLoopbackHost, cn as boolean, d as getIp, dn as looseObject, en as kAPIErrorHeaderSymbol, f as deprecate, fn as number, g as isAPIError, gn as string, h as createAuthMiddleware, hn as record, i as refreshAccessToken, j as importJWK, jt as safeJSONParse, k as decodeJwt, kt as ATTR_OPERATION_ID, l as createRateLimitKey, ln as email, m as createAuthEndpoint, mn as optional, n as socialProviders, nn as defineErrorCodes, o as createAuthorizationURL, on as any, p as normalizePathname, pn as object, pt as JWTExpired, r as validateAuthorizationCode, s as applyDefaultAccessTokenExpiry, sn as array, t as SocialProviderListEnum, tn as BASE_ERROR_CODES, tt as encode, u as findInvalidTrustedProxies, un as literal, v as hasRequestState, w as serializeCookie, x as runWithEndpointContext, y as runWithRequestState, zt as initGetFieldName } from "../_libs/@better-auth/core+[...].mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-I7tyG22E.js
...
var KEY = "floor-author";
var AuthorContext = (0, import_react.createContext)({
	author: "",
	setAuthor: () => void 0
});
function AuthorProvider({ children }) {
	const [author, setAuthorState] = (0, import_react.useState)("");
	(0, import_react.useEffect)(() => {
		try {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthorContext.Provider, {
		value: {
			author,
			setAuthor
		},
...
function useAuthor() {
	return (0, import_react.useContext)(AuthorContext);
}
function AuthorSelect() {
	const { author, setAuthor } = useAuthor();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
		className: "flex items-center gap-2 text-xs text-muted",
		children: ["Notes as", /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
			value: author,
			...
			children: [
				...
				BUILDERS.map((name) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
					value: name,
					children: name
				}, name)),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
...
function PinGate({ children }) {
	...
	const unlock = useMutation({
		mutationFn: (pin) => unlockFloor({ data: { pin } }),
		onSuccess: async () => {
			setWrong(false);
			setDigits("");
	...
	if (status.isLoading) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "pin-gate",
	...
	if (!status.data?.unlocked) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "pin-gate",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-sm text-muted",
					children: "Enter the PIN to open the board."
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						"0",
						""
					].map((key, i) => key ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						type: "button",
						className: "pin-key",
						onClick: () => submit(digits + key),
						children: key
					}, key) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {}, `pad-${i}`))
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-sm text-muted",
					children: unlock.isPending ? "Checking…" : wrong ? "Wrong PIN" : "Four digits"
				})
			]
		})
	});
...
function Shell({ children }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
			className: "sticky top-0 z-30 border-b border-border bg-surface/95 backdrop-blur-sm",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mx-auto flex max-w-[1600px] flex-col gap-2 px-3 py-2.5 sm:px-5",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center justify-between gap-3",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-baseline gap-2.5 min-w-0",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "font-semibold tracking-tight text-lg leading-tight text-primary",
							children: "CE Master"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "truncate text-sm text-muted",
							children: "A&P Chambers"
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center gap-3",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "hidden text-sm text-muted sm:block",
							children: formatShopDate(today)
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthorSelect, {})]
					})]
					...
					children: NAV.map((item) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: item.to,
							className: cn("shrink-0 rounded-[var(--radius-sm)] px-3.5 h-10 inline-flex items-center text-sm font-medium", on ? "bg-primary text-primary-fg" : quiet ? "text-faint hover:bg-surface-2 hover:text-muted" : "text-muted hover:bg-surface-2 hover:text-ink"),
							children: item.label
						}, item.to);
					})
				})]
			...
			className: "mx-auto max-w-[1600px] px-3 py-4 sm:px-5 sm:py-5",
			children
		})]
	});
}
function ScreenHeader({ title, hint, actions }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function FilterChip({ on, onClick, children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		type: "button",
		className: cn("filter-chip", on && "is-on"),
		onClick,
		children
	});
}
...
function ErrorBanner({ message }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "rounded-[var(--radius-md)] border border-danger bg-danger-bg px-4 py-3 text-sm text-danger",
		children: message
	});
}
function Toaster$1() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
		...
		toastOptions: { className: "font-sans border border-border bg-surface text-ink shadow-none" }
	});
}
var styles_default = "/assets/styles-BNEwqwWY.css";
var APP_NAME = "CE Master";
function Providers({ children }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(QueryClientProvider, {
		client: queryClient,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AuthorProvider, { children: [children, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster$1, {})] })
	});
}
...
function RootComponent() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("html", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", { children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Providers, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PinGate, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Shell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Outlet, {}) }) }) }) }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Scripts, {})
		] })]
	});
}
var $$splitComponentImporter$15 = () => import("./routes-DQUMp4Z9.mjs");
var Route$20 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$15, "component") });
var $$splitComponentImporter$14 = () => import("./dispatch-DFHjMKeD.mjs");
var Route$19 = createFileRoute("/dispatch")({
	beforeLoad: () => {
...
var loadFloor = createServerFn({ method: "GET" }).middleware([pinMiddleware]).handler(createSsrRpc("7698363a97252bb67fe34aefa39fdc9bb01e554267844d9c17d3b222a9494610"));
createServerFn({ method: "GET" }).middleware([pinMiddleware]).handler(createSsrRpc("63828aafbdc89618cee4188029fa8fc777a8df2a1f6c3ef65cca5a8bb577bdb3"));
...
})).handler(createSsrRpc("4698416b009bf9491d52783ec05830a079cac194d0fd14a63ab52731696f6deb"));
...
})).handler(createSsrRpc("84834870ceadaa319bce6f1b86e63b1749dc3f4510e2fd86e9031fa7c1ee1902"));
var passWorkOrder = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({
	woNumber: string().min(1),
	historyAuthor: string().optional()
})).handler(createSsrRpc("d7b517accce96b699dc640d1c107bc92e6e175b1258e9c4ddac3fdd8da937da7"));
var prePassWorkOrder = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({
	woNumber: string().min(1),
	historyAuthor: string().optional()
})).handler(createSsrRpc("14b0c516213dbcc2dafecb1df31c2331f2fbe3d9a055b399be796cced6777240"));
var reorderBuildOrder = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({
	who: string().min(1),
	keys: array(string())
})).handler(createSsrRpc("3afa6f029f4c21c7daf55413f5f707d0812ae85148d2851ffae45e0f326ac545"));
var createBuildTask = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({
	...
	buildOrderNotes: string().optional()
})).handler(createSsrRpc("d80e433f145d3a846f69c1ba71fa74e1ebfcf7f3eccc664fd270d8a3b77c0144"));
var updateBuildTask = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({
	...
	taskNumber: string().optional(),
	buildOrderNotes: string().optional()
})).handler(createSsrRpc("cf82fffbdd24feccf542a250307cd86ebf59ffafb708fa1995d2691144a8d3bb"));
var createProblemTicket = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({
	...
	part: string().optional()
})).handler(createSsrRpc("145889a39bef30f64b4ab5775dc27d52bede211bff23a0cdba2dcc5a9e2f2fb4"));
...
})).handler(createSsrRpc("5e3e837e89d7eeb3712632c4a6d33a5130e4e54d666c6aa1286990d2004c5f21"));
var passProblemTicket = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({ id: number().int() })).handler(createSsrRpc("b269a973cb07f1354cb01272910bee8b6d66975b4afb1b6651e4b7d8b1c7a4bc"));
var prePassProblemTicket = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({ id: number().int() })).handler(createSsrRpc("ef1d9f99ca343fffc6dcd162a92821503bd859d047a4ba84c1d2a2b46796ebd1"));
var deleteProblemTicket = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({ id: number().int() })).handler(createSsrRpc("6a45ef5bada12bb9f42b739ed6ad48efb1f89d1023d39337e92983f1f01b4645"));
var deleteBuildTask = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({ id: number().int() })).handler(createSsrRpc("04ba642b1910688e28e8cb5835c12c1dd70f93566778124186515036e19e255e"));
var addHardwareHistory = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({
	woNumber: string().min(1),
	author: string(),
	text: string().min(1)
})).handler(createSsrRpc("bac858282736cfe739354c498f35df6c9bcdd167208bf959a81605ad7ed63fa7"));
...
})).handler(createSsrRpc("522588827d1f9dc7d6125b618f85b3ab272a2820d36f48e3c162a063d211f64b"));
var updatePart = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({
	...
	notes: string().optional(),
	active: boolean().optional()
})).handler(createSsrRpc("a5c33d80767a3c32c5af9f151f644732e320ddc0c7fb8c68b0ea5c211f4f59bc"));
var addUnit = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({ woNumber: string().min(1) })).handler(createSsrRpc("3fac9595e0266337037051442bbd49e6f74279c890171f7e5ae0babed0e58274"));
...
})).handler(createSsrRpc("548e86e363999d411c30978d5f3ccd79c72d02182bffd4e33c063c269786d09f"));
var addUnitNote = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({
	id: number().int(),
	author: string(),
	text: string().min(1)
})).handler(createSsrRpc("a07d2d7775916b1a7ef0a7d667f794e03a315a79c4d33802bd2205ddbc75164e"));
var createTicket = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({
	...
	part: string().optional()
})).handler(createSsrRpc("6fd3648797fc59d138c6e202d7466ef5bc5660869cc53492aebe2fe403753d18"));
var updateTicket = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({
	...
	status: ticketStatus.optional(),
	assignedTo: string().optional()
})).handler(createSsrRpc("092a5c3c8b558ddf6b2971d996ab15839a9e786a35eba56d7761b3827e4af559"));
var addTicketNote = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({
	ticketNumber: string().min(1),
	author: string(),
	text: string().min(1)
})).handler(createSsrRpc("35d4b086f95fec74311aae704f9bd252c7d0a46a51f14e67c2cfa6b2ab23851e"));
...
})).handler(createSsrRpc("074704fd4b51152e7a964e0d97617264dd898aae8f22336bb65642df4bc11225"));
var updateSalesOrder = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({
	...
	despatchDate: string().nullable().optional(),
	notesToProduction: string().optional()
})).handler(createSsrRpc("b52eb83020d42d14a9eafd7d182a2fb63cdb8481c06e2bc31deb119693aa7ac2"));
var addSalesLine = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({
	...
	company: string().optional(),
	leadTimeWeeks: number().nullable().optional()
})).handler(createSsrRpc("eb68bbaea46f209b59975eabaa241042171da10d79b12afb0931e943cb03514d"));
var updateSalesLine = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({
	id: number().int(),
	part: string().optional(),
	qty: number().int().min(1).optional(),
	workOrderNumber: string().optional()
})).handler(createSsrRpc("2e2a2e16e34a4cb6ae6574b7274c7c3a262db175235ace0e750e90ef6d3b0e6f"));
...
})).handler(createSsrRpc("cf071420ae1cac99e7aa5aea895685743e0bb69be8f1ea2e5065775fa18f475f"));
...
})).handler(createSsrRpc("e2c25b442fb9f84c969a721d215a441e832fe09e35e08e263a8da95e995fe2d5"));
var deleteSalesLine = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({ id: number().int() })).handler(createSsrRpc("d8c61472d5304ea8ccd8cae02e2c59d4acaa79ed5a92ba18e2d4ecaccb5ab4a7"));
var wipeFloor = createServerFn({ method: "POST" }).middleware([pinMiddleware]).handler(createSsrRpc("ccf459e2a361cdec016acae3348e074c7dc115d39b629b6429a926ff0ff6ec54"));
var importSagePack = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({
	name: string(),
	kind: _enum(["csv", "xlsx"]),
	content: string()
})).handler(createSsrRpc("b309c0f6d7ed8f2f7b4f3a8fba8ecd496f2d45987f67d7ce18e0f66d78ed5fef"));
...
})).handler(createSsrRpc("f924b78bdee3d26892934ebd919bc5d891af6a416a4630eb0d95a51d050aab45"));
...
})).handler(createSsrRpc("f315b1d5a58f00c6b226a237bd592c4fd02ea190aa84b862f83839d31baeb345"));
...
})).handler(createSsrRpc("7e396e6ff3b9e80bf687398c4c26078b3d05fa3cc9b230673f2a715966afc429"));
var setPartComponentRequired = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({
	...
	required: boolean()
})).handler(createSsrRpc("bc35b1cc4716a08b2c0a4fbb34325a219cb096f2e5f6a805ff4cbd3d18a3c3cc"));
var addBuildComponent = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({ label: string().min(1) })).handler(createSsrRpc("ee632f90a2f171800fc54009cc1270ef71a008998dd266465133d8f70b0d4c3b"));
var addBuildBattery = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({ code: string().min(1) })).handler(createSsrRpc("56c66dad529e9d1a533641412695c71fcac29fc0f05ffc1190351c96dc04fb21"));
var removeBuildBattery = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({ code: string().min(1) })).handler(createSsrRpc("a589975789b9d572814b12c200bdc288169feb14cd67ed9b824aa4e75820c89e"));
var removeBuildComponent = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({ key: string().min(1) })).handler(createSsrRpc("d2fa274e0a8119bf604cd05784739efc08bc57e261d5cf9bc2a9d2659c2ce149"));
var importFloor = createServerFn({ method: "POST" }).middleware([pinMiddleware]).validator(object({ files: array(object({
	name: string(),
	kind: _enum(["csv", "xlsx"]),
	content: string()
})) })).handler(createSsrRpc("431340ca1318c4c40fc74aae3e6c2b7c9ae49d7684bf768c7a7b289070f0f269"));
var Route$18 = createFileRoute("/export.zip")({ server: { handlers: { GET: async () => {
	try {
...
var Route$17 = createFileRoute("/floor-database.txt")({ server: { handlers: { GET: async () => {
	try {
	...
	return new Response(SCHEMA_DOC, { headers: {
		"Content-Type": "text/plain; charset=utf-8",
		"Content-Disposition": "attachment; filename=\"CE-Master-database.txt\"",
		"Cache-Control": "no-store"
	} });
} } } });
var $$splitComponentImporter$13 = () => import("./load-B7vJGd6w.mjs");
var Route$16 = createFileRoute("/load")({ component: lazyRouteComponent($$splitComponentImporter$13, "component") });
var $$splitComponentImporter$12 = () => import("./login-BH6-GzYA.mjs");
...
var $$splitComponentImporter$11 = () => import("./parts-CesoN4rb.mjs");
var Route$14 = createFileRoute("/parts")({ component: lazyRouteComponent($$splitComponentImporter$11, "component") });
var $$splitComponentImporter$10 = () => import("./problems-Bb7Y-W5y.mjs");
var Route$13 = createFileRoute("/problems")({
	validateSearch: (search) => ({ pt: typeof search.pt === "string" ? search.pt : void 0 }),
	component: lazyRouteComponent($$splitComponentImporter$10, "component")
});
var $$splitComponentImporter$9 = () => import("./sales-BB6igjNC.mjs");
var Route$12 = createFileRoute("/sales")({ component: lazyRouteComponent($$splitComponentImporter$9, "component") });
var $$splitComponentImporter$8 = () => import("./shipping-BQWK2hUu.mjs");
var Route$11 = createFileRoute("/shipping")({ component: lazyRouteComponent($$splitComponentImporter$8, "component") });
var $$splitComponentImporter$7 = () => import("./tasks-CULH6Otn.mjs");
var Route$10 = createFileRoute("/tasks")({ component: lazyRouteComponent($$splitComponentImporter$7, "component") });
var $$splitComponentImporter$6 = () => import("./tickets-B5Be1VzN.mjs");
var Route$9 = createFileRoute("/tickets")({ component: lazyRouteComponent($$splitComponentImporter$6, "component") });
var $$splitComponentImporter$5 = () => import("./trace-D9nZQYbZ.mjs");
var Route$8 = createFileRoute("/trace")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
var $$splitComponentImporter$4 = () => import("./work-orders-CvTaslJr.mjs");
var Route$7 = createFileRoute("/work-orders")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var Route$6 = createFileRoute("/blank/$sheet")({ server: { handlers: { GET: async ({ params }) => {
	try {
		const { assertPin } = await import("./pin.server-BeLv6Hd3.mjs");
		assertPin();
	} catch {
...
var KEYS = new Set(SHEET_SPECS.map((s) => s.key));
var Route$5 = createFileRoute("/dump/$sheet")({ server: { handlers: { GET: async ({ params }) => {
	const sheet = params.sheet;
	if (!KEYS.has(sheet)) return new Response("Unknown sheet", { status: 404 });
	try {
		const state = await loadFloor();
		const found = floorToSheets(state).find((s) => s.key === sheet);
...
var $$splitComponentImporter$3 = () => import("./sales._soNumber-CtZFsZhd.mjs");
var Route$4 = createFileRoute("/sales/$soNumber")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./tickets._ticketNumber-C3URVZKQ.mjs");
var Route$3 = createFileRoute("/tickets/$ticketNumber")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./tickets.new-DP84qN-W.mjs");
var Route$2 = createFileRoute("/tickets/new")({
	validateSearch: (s) => {
...
var $$splitComponentImporter = () => import("./work-orders._woNumber-CjZKg-rI.mjs");
var Route$1 = createFileRoute("/work-orders/$woNumber")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
/**
		...
		hooks: { after: [{
			...
			handler: createAuthMiddleware(async (ctx) => {
				...
				if (returned instanceof Headers) {
					...
					const { setCookie } = await import("./ssr.mjs").then((n) => n.u).then((n) => n.t);
...
var DispatchRoute = Route$19.update({
	id: "/dispatch",
	path: "/dispatch",
	getParentRoute: () => Route$21
});
var ExportDotzipRoute = Route$18.update({
	id: "/export.zip",
	path: "/export.zip",
	getParentRoute: () => Route$21
});
var FloorDatabaseDottxtRoute = Route$17.update({
	id: "/floor-database.txt",
	path: "/floor-database.txt",
	getParentRoute: () => Route$21
});
var LoadRoute = Route$16.update({
	id: "/load",
	path: "/load",
	getParentRoute: () => Route$21
});
...
var PartsRoute = Route$14.update({
	id: "/parts",
	path: "/parts",
	getParentRoute: () => Route$21
});
var ProblemsRoute = Route$13.update({
	id: "/problems",
	path: "/problems",
	getParentRoute: () => Route$21
});
var SalesRoute = Route$12.update({
	id: "/sales",
	path: "/sales",
	getParentRoute: () => Route$21
});
var ShippingRoute = Route$11.update({
	id: "/shipping",
	path: "/shipping",
	getParentRoute: () => Route$21
});
...
var TicketsRoute = Route$9.update({
	id: "/tickets",
	path: "/tickets",
	getParentRoute: () => Route$21
});
var TraceRoute = Route$8.update({
	id: "/trace",
	path: "/trace",
	getParentRoute: () => Route$21
});
var WorkOrdersRoute = Route$7.update({
	id: "/work-orders",
	path: "/work-orders",
	getParentRoute: () => Route$21
});
var BlankSheetRoute = Route$6.update({
	id: "/blank/$sheet",
	path: "/blank/$sheet",
	getParentRoute: () => Route$21
});
var DumpSheetRoute = Route$5.update({
	id: "/dump/$sheet",
	path: "/dump/$sheet",
	getParentRoute: () => Route$21
});
var SalesSoNumberRoute = Route$4.update({
	id: "/$soNumber",
	path: "/$soNumber",
	getParentRoute: () => SalesRoute
});
var TicketsTicketNumberRoute = Route$3.update({
	id: "/$ticketNumber",
	path: "/$ticketNumber",
	getParentRoute: () => TicketsRoute
});
var TicketsNewRoute = Route$2.update({
	id: "/new",
	path: "/new",
	getParentRoute: () => TicketsRoute
});
var WorkOrdersWoNumberRoute = Route$1.update({
	id: "/$woNumber",
	path: "/$woNumber",
...
var rootRouteChildren = {
	...
	TraceRoute,
	WorkOrdersRoute: WorkOrdersRoute._addFileChildren(WorkOrdersRouteChildren),
	BlankSheetRoute,
	DumpSheetRoute,
	ApiAuthSplatRoute
};
...
//#endregion
export { removeBuildBattery as A, updateSalesOrder as B, importFloor as C, passWorkOrder as D, passProblemTicket as E, setWorkOrderConsumed as F, writeWorkOrderConsumedHistory as G, updateUnit as H, updateBuildTask as I, LoadingTable as J, ErrorBanner as K, updatePart as L, reorderBuildOrder as M, setPartComponentRequired as N, prePassProblemTicket as O, setWorkOrderBuildField as P, updateProblemTicket as R, despatchSalesOrder as S, loadFloor as T, updateWorkOrder as U, updateTicket as V, wipeFloor as W, cn as X, ScreenHeader as Y, useAuthor as Z, createWorkOrder as _, addBuildBattery as a, deleteSalesLine as b, addSalesLine as c, addUnitNote as d, createBuildTask as f, createTicket as g, createSalesOrder as h, Route$13 as i, removeBuildComponent as j, prePassWorkOrder as k, addTicketNote as l, createProblemTicket as m, Route$2 as n, addBuildComponent as o, createPart as p, FilterChip as q, Route$3 as r, addHardwareHistory as s, router_exports as t, addUnit as u, deleteBuildTask as v, importSagePack as w, despatchLine as x, deleteProblemTicket as y, updateSalesLine as z };
